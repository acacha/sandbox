<template>
    <div class="row">
        <div class="col-md-3">
            ...
            <personal-data-box></personal-data-box>
        ...
        <div class="col-md-9">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class=""><a href="#user" data-toggle="tab" aria-expanded="false">User</a></li>
                    <li class=""><a href="#personal" data-toggle="tab" aria-expanded="false">Personal</a></li>
...
<script>
  ...
  import PersonalDataBox from '../persons/PersonalDataBox.vue'
  ...
  export default {
    ...
    components: {
      ...
      'personal-data-box' : PersonalDataBox
    },
    props: {
      apiUrl: {
        type: String,
        default: 'http://localhost:8080/api/v1/user/profile'
      },
      id: {
        type: Number,
        default: null
