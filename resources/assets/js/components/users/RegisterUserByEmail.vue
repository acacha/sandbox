...
<script>
  ...
  import SimpleStepForm from '../forms/SimpleStepForm.vue'

  export default {
    components: {
      'simple-step-form' : SimpleStepForm
    }
  }
